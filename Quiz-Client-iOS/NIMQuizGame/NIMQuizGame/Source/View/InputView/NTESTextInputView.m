...
- (UIButton *)sendButton
{
    if (!_sendButton) {
        ...
        [_sendButton setBackgroundImage:[UIImage imageNamed:@"chat_send"] forState:UIControlStateNormal];
        [_sendButton setBackgroundImage:[UIImage imageNamed:@"chat_send_pressed"] forState:UIControlStateSelected];
