...
import com.netease.nim.quizgame.common.annotation.Keep;
...
public class JsonObject2Model {
    ...
    private static Object makeTypeSafeValue(Class<?> type, String value) throws IllegalArgumentException {
    ...
    private static boolean isWrappedPrimitive(Class<?> type) {
        return (type.getName().equals(Boolean.class.getName()) || type.getName().equals(Byte.class.getName())
