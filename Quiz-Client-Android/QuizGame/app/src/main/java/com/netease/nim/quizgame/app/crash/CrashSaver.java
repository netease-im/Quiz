...
import com.netease.nim.quizgame.common.utils.MD5;
...
class CrashSaver {
    ...
    static void save(Context context, final String logDir, Throwable ex) {
        Writer writer = null;
        ...
        try {
            String filePath = logDir + "/" + filename + ".crashlog";
            ...
            mBufferedWriter.append(CrashSnapshot.snapshot(context, timestamp, stackTrace, count));
