...
public class CommonConst {
    ...
    public static final String QUIZ_ROOM_DO_REQUEST_ATTRIBUTE = "quiz_room_request_attribute";

    /**
     * 有效答题时间，单位秒
     */
    public static final int VALID_ANSWER_PERIOD = 20;

    /**
     * 单局游戏复活次数限制
     */
    public static final int BRING_BACK_LIMIT = 1;

    /**
     * 赢家示例数量
     */
    public static final int WINNER_SAMPLE_COUNT = 5;
}
