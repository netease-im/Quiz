...
public class NIMServerApiHttpDao extends AbstractApiHttpDao {
     ...
     * @return
     */
    public NimResponseDTO pushQueue(long roomId, String key, String value) {
        MultiValueMap<String, String> param = new LinkedMultiValueMap<>(3);
        param.set("roomid", String.valueOf(roomId));
        param.set("key", key);
        ...
        return JSONObject.parseObject(res, NimResponseDTO.class);
    }
     ...
     * @return
     */
    public NimResponseDTO popQueue(long roomId, String key) {
        MultiValueMap<String, String> param = new LinkedMultiValueMap<>(2);
        param.set("roomid", String.valueOf(roomId));
     ...
     * @return
     */
    public NimResponseDTO listQueue(long roomId) {
     ...
     * @return
     */
    public NimResponseDTO sendChatroomMsg(long roomId, String attach, String fromAccid, boolean highPriority) {
        MultiValueMap<String, String> param = new LinkedMultiValueMap<>(6);
        param.set("roomid", String.valueOf(roomId));
        param.set("msgId", UUIDUtil.getUUID());
        param.set("msgType", "100");
        param.set("attach", attach);
        param.set("fromAccid", fromAccid);
        if (highPriority) {
            param.set("highPriority", "true");
        }

        String res = postFormData("chatroom/sendMsg.action", param);
        if (StringUtils.isBlank(res)) {
            throw new ChatroomException();
        }
        return JSONObject.parseObject(res, NimResponseDTO.class);
