package com.netease.nim.quizgame.common.ui;
...
import com.netease.nim.quizgame.common.utils.ReflectionUtil;
...
public abstract class UI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtil.app("activity: " + getClass().getSimpleName() + " onCreate()");
    }
    ...
    protected void onDestroy() {
        ...
        LogUtil.app("activity: " + getClass().getSimpleName() + " onDestroy()");
        destroyed = true;
    }
    ...
    public void setToolBar(int toolBarId, ToolBarOptions options) {
        ...
        if (options.isTitleHide && getSupportActionBar() != null) {
